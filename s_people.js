...
const handlerWrapperArgs = { functionName: 'api-swapi-sls-dev-people', timeout: 6 };

try {
  const userHandler = require('./handler.js');
  module.exports.handler = serverlessSDK.handler(userHandler.swPeople, handlerWrapperArgs);
} catch (error) {
