...
const handlerWrapperArgs = { functionName: 'api-swapi-sls-dev-createPeople', timeout: 6 };

try {
  const userHandler = require('./handler.js');
  module.exports.handler = serverlessSDK.handler(userHandler.swCreatePeople, handlerWrapperArgs);
} catch (error) {
